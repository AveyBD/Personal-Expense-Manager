...
/**
 * Cetra App Framework configuration file
*/
...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "cetra_pem"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{0CE8814C-5AE1-40E3-91A4-888B83DCC6F0}"); // Project ID (GUID)
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'FcYummVwH7J7yyBu'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "css/cetra_pem.css"); // Project stylesheet file name
...
// Font path
$FONT_PATH = realpath('./css/fonts'); // No trailing delimiter
...
$STYLESHEET_FILES = [];
$STYLESHEET_FILES[] = "https://fonts.googleapis.com/css?family=PT+Sans";
$STYLESHEET_FILES[] = "https://fonts.googleapis.com/css?family=Oswald";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "Rutu@2710", "db" => "cetra_pem", "qs" => "`", "qe" => "`");
...
// Language settings
define(PROJECT_NAMESPACE . "LANGUAGE_FOLDER", $RELATIVE_PATH . "lang/");
$LANGUAGE_FILE = [];
...
define(PROJECT_NAMESPACE . "LOCALE_FOLDER", $RELATIVE_PATH . "lang/");
...
define(PROJECT_NAMESPACE . "ADMIN_USER_NAME", "ruturaaj"); // Administrator user name
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "Commocava@2710"); // Administrator password
...
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "login");
define(PROJECT_NAMESPACE . "LOGIN_PASSWORD_FIELD_NAME", "password");
define(PROJECT_NAMESPACE . "USER_ID_FIELD_NAME", "id");
define(PROJECT_NAMESPACE . "USER_LEVEL_FIELD_NAME", "user_level");
...
define(PROJECT_NAMESPACE . "USER_TABLE", "`users`");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`login` = '%u')");
define(PROJECT_NAMESPACE . "USER_ID_FILTER", "(`id` = %u)");
...
$EMAIL_TEMPLATE_PATH = "inc/html"; // Template path
