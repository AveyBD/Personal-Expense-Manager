...
// Page class
//
class pem_expenses_list extends pem_expenses
{
	...
	// Page object name
	public $PageObjName = "pem_expenses_list";

	// Grid form hidden field names
	public $FormName = "fpem_expenseslist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "pem_expensesadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "pem_expensesdelete.php";
		$this->MultiUpdateUrl = "pem_expensesupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fpem_expenseslistsrch";
	...
	public function run()
	{
		...
		$this->exp_remarks->Visible = FALSE;
		$this->user_id->Visible = FALSE;
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->exp_id->setFormValue($arKeyFlds[0]);
			if (!is_numeric($this->exp_id->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = "";
		$savedFilterList = "";
		$filterList = Concat($filterList, $this->exp_id->AdvancedSearch->toJson(), ","); // Field exp_id
		$filterList = Concat($filterList, $this->exp_item->AdvancedSearch->toJson(), ","); // Field exp_item
		$filterList = Concat($filterList, $this->exp_category->AdvancedSearch->toJson(), ","); // Field exp_category
		$filterList = Concat($filterList, $this->payment_type->AdvancedSearch->toJson(), ","); // Field payment_type
		$filterList = Concat($filterList, $this->exp_source->AdvancedSearch->toJson(), ","); // Field exp_source
		$filterList = Concat($filterList, $this->exp_amount->AdvancedSearch->toJson(), ","); // Field exp_amount
		$filterList = Concat($filterList, $this->exp_date->AdvancedSearch->toJson(), ","); // Field exp_date
		$filterList = Concat($filterList, $this->exp_remarks->AdvancedSearch->toJson(), ","); // Field exp_remarks
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fpem_expenseslistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field exp_id
		$this->exp_id->AdvancedSearch->SearchValue = @$filter["x_exp_id"];
		$this->exp_id->AdvancedSearch->SearchOperator = @$filter["z_exp_id"];
		$this->exp_id->AdvancedSearch->SearchCondition = @$filter["v_exp_id"];
		$this->exp_id->AdvancedSearch->SearchValue2 = @$filter["y_exp_id"];
		$this->exp_id->AdvancedSearch->SearchOperator2 = @$filter["w_exp_id"];
		$this->exp_id->AdvancedSearch->save();

		// Field exp_item
		$this->exp_item->AdvancedSearch->SearchValue = @$filter["x_exp_item"];
		$this->exp_item->AdvancedSearch->SearchOperator = @$filter["z_exp_item"];
		$this->exp_item->AdvancedSearch->SearchCondition = @$filter["v_exp_item"];
		$this->exp_item->AdvancedSearch->SearchValue2 = @$filter["y_exp_item"];
		$this->exp_item->AdvancedSearch->SearchOperator2 = @$filter["w_exp_item"];
		$this->exp_item->AdvancedSearch->save();

		// Field exp_category
		$this->exp_category->AdvancedSearch->SearchValue = @$filter["x_exp_category"];
		$this->exp_category->AdvancedSearch->SearchOperator = @$filter["z_exp_category"];
		$this->exp_category->AdvancedSearch->SearchCondition = @$filter["v_exp_category"];
		$this->exp_category->AdvancedSearch->SearchValue2 = @$filter["y_exp_category"];
		$this->exp_category->AdvancedSearch->SearchOperator2 = @$filter["w_exp_category"];
		$this->exp_category->AdvancedSearch->save();
		...
		// Field exp_source
		$this->exp_source->AdvancedSearch->SearchValue = @$filter["x_exp_source"];
		$this->exp_source->AdvancedSearch->SearchOperator = @$filter["z_exp_source"];
		$this->exp_source->AdvancedSearch->SearchCondition = @$filter["v_exp_source"];
		$this->exp_source->AdvancedSearch->SearchValue2 = @$filter["y_exp_source"];
		$this->exp_source->AdvancedSearch->SearchOperator2 = @$filter["w_exp_source"];
		$this->exp_source->AdvancedSearch->save();

		// Field exp_amount
		$this->exp_amount->AdvancedSearch->SearchValue = @$filter["x_exp_amount"];
		$this->exp_amount->AdvancedSearch->SearchOperator = @$filter["z_exp_amount"];
		$this->exp_amount->AdvancedSearch->SearchCondition = @$filter["v_exp_amount"];
		$this->exp_amount->AdvancedSearch->SearchValue2 = @$filter["y_exp_amount"];
		$this->exp_amount->AdvancedSearch->SearchOperator2 = @$filter["w_exp_amount"];
		$this->exp_amount->AdvancedSearch->save();

		// Field exp_date
		$this->exp_date->AdvancedSearch->SearchValue = @$filter["x_exp_date"];
		$this->exp_date->AdvancedSearch->SearchOperator = @$filter["z_exp_date"];
		$this->exp_date->AdvancedSearch->SearchCondition = @$filter["v_exp_date"];
		$this->exp_date->AdvancedSearch->SearchValue2 = @$filter["y_exp_date"];
		$this->exp_date->AdvancedSearch->SearchOperator2 = @$filter["w_exp_date"];
		$this->exp_date->AdvancedSearch->save();

		// Field exp_remarks
		$this->exp_remarks->AdvancedSearch->SearchValue = @$filter["x_exp_remarks"];
		$this->exp_remarks->AdvancedSearch->SearchOperator = @$filter["z_exp_remarks"];
		$this->exp_remarks->AdvancedSearch->SearchCondition = @$filter["v_exp_remarks"];
		$this->exp_remarks->AdvancedSearch->SearchValue2 = @$filter["y_exp_remarks"];
		$this->exp_remarks->AdvancedSearch->SearchOperator2 = @$filter["w_exp_remarks"];
		$this->exp_remarks->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->exp_item, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->exp_remarks, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->exp_item); // exp_item
			$this->updateSort($this->exp_category); // exp_category
			$this->updateSort($this->exp_source); // exp_source
			$this->updateSort($this->exp_amount); // exp_amount
			$this->updateSort($this->exp_date); // exp_date
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				$orderBy = "";
				$this->setSessionOrderBy($orderBy);
				$this->exp_item->setSort("");
				$this->exp_category->setSort("");
				$this->exp_source->setSort("");
				$this->exp_amount->setSort("");
				$this->exp_date->setSort("");
			}
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ew-multi-select\" value=\"" . HtmlEncode($this->exp_id->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\">";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew.submitAction(event,{f:document.fpem_expenseslist,url:'" . $this->MultiDeleteUrl . "',data:{action:'show'}});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->canDelete());
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fpem_expenseslistsrch\" href=\"#\">" . $Language->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpem_expenseslistsrch\" href=\"#\">" . $Language->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fpem_expenseslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpem_expenseslistsrch\">" . $Language->Phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function newRow()
	{
		...
		$row['exp_id'] = NULL;
		$row['exp_item'] = NULL;
		$row['exp_category'] = NULL;
		$row['payment_type'] = NULL;
		$row['exp_source'] = NULL;
		$row['exp_amount'] = NULL;
		$row['exp_date'] = NULL;
		$row['exp_remarks'] = NULL;
		$row['user_id'] = NULL;
		return $row;
	}
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_pem_expenses\" class=\"ew-export-link ew-email\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_pem_expenses',hdr:ew.language.phrase('ExportToEmailText'),f:document.fpem_expenseslist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
