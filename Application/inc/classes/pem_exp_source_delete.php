...
// Page class
//
class pem_exp_source_delete extends pem_exp_source
{
	...
	// Page object name
	public $PageObjName = "pem_exp_source_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("pem_exp_sourcelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pem_exp_sourcelist.php"); // Return to list
			}
		}
	}
