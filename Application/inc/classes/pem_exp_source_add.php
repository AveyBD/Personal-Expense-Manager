...
// Page class
//
class pem_exp_source_add extends pem_exp_source
{
	...
	// Page object name
	public $PageObjName = "pem_exp_source_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("source_id") !== NULL) {
				...
				$this->setKey("source_id", $this->source_id->CurrentValue); // Set up key
			} else {
				$this->setKey("source_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "pem_exp_sourceview.php")
