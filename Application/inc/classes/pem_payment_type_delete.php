...
// Page class
//
class pem_payment_type_delete extends pem_payment_type
{
	...
	// Page object name
	public $PageObjName = "pem_payment_type_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("pem_payment_typelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pem_payment_typelist.php"); // Return to list
			}
		}
	}
