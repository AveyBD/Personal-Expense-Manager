...
// Page class
//
class pem_expenses_delete extends pem_expenses
{
	...
	// Page object name
	public $PageObjName = "pem_expenses_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("pem_expenseslist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pem_expenseslist.php"); // Return to list
			}
		}
	}
