...
// Page class
//
class pem_payment_type_view extends pem_payment_type
{
	...
	// Page object name
	public $PageObjName = "pem_payment_type_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("type_id") !== NULL) {
				...
				$returnUrl = "pem_payment_typelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "pem_payment_typelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "pem_payment_typelist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
