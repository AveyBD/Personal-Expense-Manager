...
// Page class
//
class pem_exp_source_edit extends pem_exp_source
{
	...
	// Page object name
	public $PageObjName = "pem_exp_source_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_source_id")) {
				$this->source_id->setFormValue($CurrentForm->getValue("x_source_id"));
			}
		} else {
			...
			$loadByQuery = FALSE;
			if (Get("source_id") !== NULL) {
				$this->source_id->setQueryStringValue(Get("source_id"));
				$loadByQuery = TRUE;
			} else {
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("pem_exp_sourcelist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "pem_exp_sourcelist.php")
