...
class users_edit extends users
{
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// profile_photo
			$this->profile_photo->setDbValueDef($rsnew, $this->profile_photo->CurrentValue, NULL, $this->profile_photo->ReadOnly);

			// profile_info
			$this->profile_info->setDbValueDef($rsnew, $this->profile_info->CurrentValue, NULL, $this->profile_info->ReadOnly);
