...
// Page class
//
class pem_categories_view extends pem_categories
{
	...
	// Page object name
	public $PageObjName = "pem_categories_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("cat_id") !== NULL) {
				...
				$this->cat_id->setQueryStringValue(Key(0));
				$this->RecKey["cat_id"] = $this->cat_id->QueryStringValue;
			} elseif (Post("cat_id") !== NULL) {
				$this->cat_id->setFormValue(Post("cat_id"));
				$this->RecKey["cat_id"] = $this->cat_id->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->cat_id->setFormValue(Route(2));
				$this->RecKey["cat_id"] = $this->cat_id->FormValue;
			} else {
				$returnUrl = "pem_categorieslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "pem_categorieslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "pem_categorieslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
