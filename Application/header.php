...
<link rel="stylesheet" type="text/css" href="<?php echo $RELATIVE_PATH ?>css/adminlte3/css/<?php echo CssFile("adminlte.css") ?>">
<link rel="stylesheet" type="text/css" href="<?php echo $RELATIVE_PATH ?>css/adminlte3/css/<?php echo CssFile("components.css") ?>">
<link rel="stylesheet" type="text/css" href="<?php echo $RELATIVE_PATH ?>plugins/font-awesome/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo $RELATIVE_PATH ?>css/css/jquery.fileupload.css">
<link rel="stylesheet" type="text/css" href="<?php echo $RELATIVE_PATH ?>css/css/jquery.fileupload-ui.css">
<link rel="stylesheet" type="text/css" href="<?php echo $RELATIVE_PATH ?>vendor/colorbox/colorbox.css">
...
<script src="<?php echo $RELATIVE_PATH ?>js/jquery.ui.widget.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/jquery.storageapi.min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>vendor/bootstrap4/js/bootstrap.bundle.min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/adminlte3/js/adminlte.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>plugins/slimScroll/jquery.slimscroll.min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/jquery.fileDownload.min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/load-image.all.min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/jqueryfileupload.min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/typeahead.jquery.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>vendor/colorbox/jquery.colorbox-min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/mobile-detect.min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>plugins/moment/moment.min.js"></script>
...
<?php } ?>
<script src="<?php echo $RELATIVE_PATH ?>js/jsrender.min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/ewp15.js"></script>
<script>
jQuery.extend(ew, {
...
<script src="<?php echo $RELATIVE_PATH ?>js/jquery.ewjtable.js"></script>
<script>
<?php echo $Language->toJson() ?>
ew.vars = <?php echo JsonEncode($CLIENT_VAR) ?>;
</script>
<link rel="stylesheet" type="text/css" href="<?php echo $RELATIVE_PATH ?>css/bootstrap-datetimepicker.css">
<script src="<?php echo $RELATIVE_PATH ?>js/bootstrap-datetimepicker.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/ewdatetimepicker.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>js/userfn15.js"></script>
<script>

// Write your client script here, no need to add script tags.
</script>
<?php } ?>
<meta name="generator" content="Cetra Web Apps">
</head>
...
<div class="wrapper ew-layout">
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<img src="<?php echo $RELATIVE_PATH ?>images/PEM-Logo.png" alt="" class="brand-image ew-brand-image">
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->
