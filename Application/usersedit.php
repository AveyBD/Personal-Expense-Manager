...
fusersedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($users_edit->_login->Required) { ?>
		...
		<?php } ?>
		<?php if ($users_edit->profile_photo->Required) { ?>
		...
		<?php } ?>
		<?php if ($users_edit->profile_info->Required) { ?>
...
fusersedit.lists["x_user_level"] = <?php echo $users_edit->user_level->Lookup->toClientList() ?>;
fusersedit.lists["x_user_level"].options = <?php echo JsonEncode($users_edit->user_level->lookupOptions()) ?>;
...
<?php } else { ?>
<table id="tbl_usersedit" class="table ew-desktop-table"><!-- table* -->
<?php } ?>
...
<?php } else { ?>
	<tr id="r_id">
		<td class="<?php echo $users_edit->TableLeftColumnClass ?>"><span id="elh_users_id"><?php echo $users->id->caption() ?><?php echo ($users->id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_name" class="form-group row">
		<label id="elh_users_name" for="x_name" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->name->caption() ?><?php echo ($users->name->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php } else { ?>
	<tr id="r_name">
		<td class="<?php echo $users_edit->TableLeftColumnClass ?>"><span id="elh_users_name"><?php echo $users->name->caption() ?><?php echo ($users->name->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r__login" class="form-group row">
		<label id="elh_users__login" for="x__login" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->_login->caption() ?><?php echo ($users->_login->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->_login->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r__login">
		<td class="<?php echo $users_edit->TableLeftColumnClass ?>"><span id="elh_users__login"><?php echo $users->_login->caption() ?><?php echo ($users->_login->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_user_level" class="form-group row">
		<label id="elh_users_user_level" for="x_user_level" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->user_level->caption() ?><?php echo ($users->user_level->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php } else { ?>
	<tr id="r_user_level">
		<td class="<?php echo $users_edit->TableLeftColumnClass ?>"><span id="elh_users_user_level"><?php echo $users->user_level->caption() ?><?php echo ($users->user_level->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_profile_photo" class="form-group row">
		<label id="elh_users_profile_photo" for="x_profile_photo" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->profile_photo->caption() ?><?php echo ($users->profile_photo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->profile_photo->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_profile_photo">
		<td class="<?php echo $users_edit->TableLeftColumnClass ?>"><span id="elh_users_profile_photo"><?php echo $users->profile_photo->caption() ?><?php echo ($users->profile_photo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_profile_info" class="form-group row">
		<label id="elh_users_profile_info" for="x_profile_info" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->profile_info->caption() ?><?php echo ($users->profile_info->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->profile_info->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_profile_info">
		<td class="<?php echo $users_edit->TableLeftColumnClass ?>"><span id="elh_users_profile_info"><?php echo $users->profile_info->caption() ?><?php echo ($users->profile_info->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></span></td>
